...
<head>
  ...
  <title>Hua Covid-19 Tracker | Covid-19 Case</title>
  <style>
    .navigation {
      height: 70px;
      background:black;
...
<sec:authorize access="hasRole('ADMIN')">
  ...
  <br><br>
  <h2 style="text-align: center;">Κρούσματα Covid-19</h2>
  <table style="width: 100%; margin: 40px;">
    <thead>
    <tr>
      <th>Αριθμός μητρώου</th>
      <th>Ημερομηνία διάγνωσης</th>
    </tr>
    </thead>
    <tbody>
    <c:forEach var="covidCase" items="${covidCases}">
    <tr class="even:bg-gray-50">
      <td class="py-4 px-6">${covidCase.getUsername()}</td>
      <td class="py-4 px-6">${covidCase.getDate()}</td>
    </tr>
    </c:forEach>
  </table>
</sec:authorize>
